                        ...
                        .executes(context -> {
                            ...
                            if (player != null) {
                                ...
                                if (source.isPlayer()) {
                                    ...
                                    Msg.sendColoredMsgToCommandSender(source, "Sent particles to " + playerName, ChatFormatting.GREEN);
                                }
                            } else {
                                if (source.isPlayer()) {
                                    ServerPlayer sender = source.getPlayerOrException();
                                    ...
                                    Msg.sendColoredMsgToCommandSender(source,"Player not found", ChatFormatting.RED);
                                }
                            }
