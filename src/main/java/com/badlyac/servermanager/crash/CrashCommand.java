                ...
                .then(Commands.argument("playerName", StringArgumentType.string())
                                .executes(context -> {
                                    ...
                                    if (player != null) {
                                        ...
                                        ColoredMsg.sendToCommandSender(sender, "Sent particles to " + playerName, ChatFormatting.GREEN);
                                    } else {
                                        ColoredMsg.sendToCommandSender(sender, "Player not found", ChatFormatting.RED);
                                    }
