                        ...
                        .then(Commands.argument("rank", StringArgumentType.string())
                                .then(Commands.argument("permission", StringArgumentType.string())
                                        .executes(context -> {
                                            ...
                                            Msg.sendColoredMsgToCommandSender(context.getSource(),"Permission " + permission + " added to rank " + rank, ChatFormatting.GREEN);
                                            return 1;
                                        }))))
                        ...
                        .then(Commands.argument("rank", StringArgumentType.string())
                                .then(Commands.argument("permission", StringArgumentType.string())
                                        .executes(context -> {
                                            String rank = StringArgumentType.getString(context, "rank");
                                            String permission = StringArgumentType.getString(context, "permission");
                                            Msg.sendColoredMsgToCommandSender(context.getSource(), "Permission " + permission + " removed from rank " + rank, ChatFormatting.GREEN);
