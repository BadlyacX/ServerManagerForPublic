                                ...
                                .then(Commands.argument("rank", StringArgumentType.string())
                                        .executes(context -> {
                                            ...
                                            if (player != null) {
                                                ...
                                                Msg.sendColoredMsgToCommandSender(context.getSource(), "Rank " + rank + " set for " + playerName, ChatFormatting.GREEN);
                                            } else {
                        ...
                        .then(Commands.argument("player", StringArgumentType.string())
                                .executes(context -> {
                                    ...
                                    if (player != null) {
                                        ...
                                        Msg.sendColoredMsgToCommandSender(context.getSource(), "Rank removed for " + playerName, ChatFormatting.GREEN);
                                    } else {
                                        Msg.sendColoredMsgToCommandSender(context.getSource(), "Player not found", ChatFormatting.RED);
                                    }
                                    return 1;
