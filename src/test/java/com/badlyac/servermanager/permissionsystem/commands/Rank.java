...
public class Rank {
    ...
    private static int setRank(CommandContext<CommandSourceStack> context, String playerSelector, String rank) {
        try {
            ...
            Msg.sendColoredMsgToCommandSender(context.getSource(),"An error occurred while setting the rank: " + e.getMessage(), ChatFormatting.RED);
    ...
    private static Collection<ServerPlayer> getPlayersFromSelector(CommandContext<CommandSourceStack> context, String playerSelector) {
        try {
            ...
            Msg.sendColoredMsgToCommandSender(context.getSource(), "Failed to parse player selector: " + playerSelector, ChatFormatting.RED);
            Msg.printStackTrace(e);
            return null;
        }
    }
